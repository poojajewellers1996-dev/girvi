...
import { Diamond, LayoutDashboard, PlusCircle, FolderOpen, BookOpen, Repeat, ScrollText, Settings, X, Calculator, PackageCheck, CheckCircle2, CheckCircle, Receipt } from 'lucide-react';
...
export default function Sidebar({ isOpen, setIsOpen }) {
  const navItems = [
    ...
    { name: 'Bank Release Ledger', path: '/repledge-release-ledger', icon: CheckCircle },
